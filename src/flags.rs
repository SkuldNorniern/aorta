...
impl Flags {
    pub fn new() -> Self {
        ...
        flags.insert("help".to_string(), Flag {
            short: "-h".to_string(),
            long: "--help".to_string(),
        ...
        flags.insert("version".to_string(), Flag {
            short: "-v".to_string(),
        ...
        flags.insert("config".to_string(), Flag {
            short: "-c".to_string(),
        ...
        flags.insert("quiet".to_string(), Flag {
            short: "-q".to_string(),
        ...
        flags.insert("debug".to_string(), Flag {
            short: "-d".to_string(),
                ...
                if arg == &flag.short || arg == &flag.long {
                    ...
                    if arg == "-c" || arg == "--config" {
                        if i + 1 < args.len() {
                            ...
                            return Err(ShellError::FlagError(
